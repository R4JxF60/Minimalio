        ...
        <section className="mx-auto pl-9 pr-9 sm:p-0 container md:flex justify-between max-h-fit min-h-[100vh] text-mid-black" id="skills">
            <div className="md:mt-52 mt-32 w-full md:w-[52%]">
                ...
                <Text>
                    ...
                    <p>
                        And also I have experience in responsive web development, UI/UX designing, HTML5, CSS3, Javascript(ES6+), and Typescript. Addition all these, I have experience in backend development with Java Spring, PHP and NodeJs.
                    </p>
                </Text>
            </div>
            <div className="md:w-[38%] w-full md:mt-[304px] mt-16">
                <div className="mt-12 sm:mt-16"> 
                    ...
                    <div className="mb-6">
                        <TagBoard tags={["java", "nodejs", "restapis", "springboot", "c/cpp", "python", "grpc", "php", "mvc", "sql", "mongodb", "express", "fastify"]} prefix="skills-backend" />
                    </div>
                    <div className="mb-6">
                        <TagBoard tags={["reactjs", "javascript", "nextjs", "typescript", "ui/ux", "html", "css", "flux", "tailwind"]} prefix="skills-frontend" />
                    </div>
