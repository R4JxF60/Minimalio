...
function Home(props) {
    return (
        <section className="flex flex-col justify-center h-screen min-h-[40vh] relative">
            <h1 className="font-sen font-normal text-8xl md:block hidden mb-3">@rajitha_kumara</h1>
            <h1 className="font-sen font-normal block md:hidden mb-3 text-7xl">Rajitha Kumara</h1>
